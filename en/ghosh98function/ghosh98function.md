...
Let $f \nu _ { _ i }$ be the objective functional value of an individual $I _ { \phantom { } _ { i } }$ and let its age be $a _ { _ i \cdot }$ . Then the effective fitness of this individual $I _ { \phantom { } _ { i } }$ may be defined as $\mathit { f i t } _ { \mathit { i } } = \mathit { F } ( g ( \mathit { f i } _ { \mathit { i } } ) , \mathit { h } ( a _ { \mathit { i } } ) )$ , where $F$ , $\mathbf { g }$ and $h$ are suitable functions. In the present study we have made $F , g$ and $h$ to lie in [0, 1].
...
The function is assumed to be symmetric about $b / 2$ , and thus the function has only two parameters ( $^ b$ & $^ { b 1 }$ or $^ { b 2 }$ ). In this case individuals having ages in the range $[ b 1 , b 2 ]$ are assumed to be the fittest (with respect to age) for genetic operations. Fig. 1 shows the shape of this function for $b 1 = 2 5$ , $b 2 = 7 5$ and $b = 1 0 0$ .
...
![](images/974c3de043f2ecd57630e5ac1b43cf4249e83645a8f88ed7ed61280382d3c1b4.jpg)  
...
with $\beta \in [ 0 , 1 ]$ . Here, $x _ { i } = g ( \mathcal { k } _ { i } )$ and $y _ { _ i } = h ( a _ { _ i } )$ .
...
![](images/5bc5e96849517c4067f1b2578dde9777c70a796af78c9712bdbd0f23b6fefec2.jpg)  
...
It can be noted that $f ^ { \star 1 }$ and $f \dot { r } 2$ have the same optimum (maximum) functional value with $f r$ (equation 5), but the optimum points are different. In the first case (equation 6) the optimum point is shifted from 0.1 to 0.5 (small shift), whereas in the second case (equation 7) the optimum point is shifted from 0.1 to 95.5 (very large shift) at $\scriptstyle { T = 2 0 , 0 0 0 }$ .
...
![](images/372c48709774784ae5b09b29eda8898737d9489ea729aab2cdf7f67e9e2c770c.jpg)  
Fig. 3 Mean best solution with iterations for (a) $f r 1 , ( \mathbf { b } ) f r 2$
...
Once again, findings for other values of $\$ 100 t a5$ in [0.3- 0.8] were also similar. Diversity of the population by the aGA was found to be more than that of the SSGA; and this is in agreement with the findings of Section 3.1.

![](images/d88b6181c8b397c62018a2de8dab5cb5aee8bd40d0b4d56cad47d3eaeadd07e4.jpg)  
